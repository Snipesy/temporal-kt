 ...
 *
 * Adapted verbatim from kotlinx-rpc's CSM template processor:
 *   https://github.com/Kotlin/kotlinx-rpc/blob/main/gradle-conventions/src/main/kotlin/util/csm/template.kt
 *
 * Selects one of multiple `//##csm` directive blocks per file based on the active Kotlin
 * compiler version, emitting a single-version source file. See
 * `compiler-plugin/src/main/templates/.../TemporalIrApi.kt` for a usage example.
 */

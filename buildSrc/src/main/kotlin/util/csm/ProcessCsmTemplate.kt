 ...
 *
 * Adapted from kotlinx-rpc:
 *   https://github.com/Kotlin/kotlinx-rpc/blob/main/gradle-conventions/src/main/kotlin/util/csm/task.kt
 */
...
@CacheableTask
abstract class ProcessCsmTemplate
    @Inject
    constructor(
        @get:Input val kotlinCompilerVersion: String,

        ...
        runTemporalTest {
            ...
            val successHandle =
                client.startWorkflow<String>(
                    workflowType = "SuccessfulWorkflow",
                    taskQueue = taskQueue,
                    args = listOf("after cancellation"),
                )
